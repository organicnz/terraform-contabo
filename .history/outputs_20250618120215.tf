...
output "security_group_id" {
  ...
  value       = var.enable_security_group ? contabo_security_group.main[0].security_group_id : null
}

output "security_group_rules" {
  description = "Security group rules (if created)"
  value       = var.enable_security_group ? contabo_security_group.main[0].rule : null
}
